const onsikgo = {
  ...
  연결하는 B2C 서비스입니다.`,
  role: `👇다음 기능을 구현하였습니다👇<br/>
  Vue와 Vuex를 사용하여 프론트 화면을 구성하였습니다<br/>
...
const mlbti = {
  ...
  role: `👇다음 기능을 구현하였습니다👇<br/>
  React와 Redux를 사용하여 프론트 화면을 구성하였습니다<br/>
...
const dstation = {
  ...
  role: `👇다음 기능을 구현하였습니다👇<br/>
  React와 Recoil을 사용하여 프론트 화면을 구성하였습니다<br/>
  ...
  경험치를 통해 나만의 학습 수준을 한 눈에 알 수 있게 구성하였습니다<br/>
  `,
};
